...
const BlogSection = () => {
  const blogs = [
    { id: 1, img: "https://vela-kazan.myshopify.com/cdn/shop/articles/1_800x515.jpg?v=1511574495" },
    { id: 2, img: "https://vela-kazan.myshopify.com/cdn/shop/articles/2_800x515.jpg?v=1511574495" },
    { id: 3, img: "https://vela-kazan.myshopify.com/cdn/shop/articles/3_800x515.jpg?v=1511574496" },
    { id: 4, img: "https://vela-kazan.myshopify.com/cdn/shop/articles/4_800x515.jpg?v=1511574496" },
  ];

  return (
    <div>
      <section className="max-w-[1320px] mx-auto px-[10px] bg-[#FFFFFF] py-20 relative">
        <div className="mb-10">
          <HeadingText
            ...
            <SwiperSlide key={item.id}>
              <div className="bg-white  hover:shadow-md transition-all duration-300">
                ...
                <div className="mt-5">
                  ...
                  <button
                    className="border border-[#EBEBEB] text-[14px] text-[#201f1f] font-medium py-[17px] px-[42px] hover:border-[#BC8246] hover:text-[#BC8246] transition-all duration-400"
                  >
                    Read More
                  </button>
                </div>
