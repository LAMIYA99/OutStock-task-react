    ...
    <div className="bg-[#F6F6F6] mb-[200px] h-[700px]">
      <div className="mx-auto px-4 sm:px-6 lg:px-10 max-w-[1320px]">
        <Swiper className="mySwiper relative">
          <SwiperSlide>
            <div
              className="w-full bg-no-repeat bg-cover h-[400px] sm:h-[500px] lg:h-[650px] flex items-center justify-start"
              style={{
                backgroundImage:
            ...
            >
              <div className="flex flex-col items-start justify-center px-4 sm:px-8 lg:px-12">
                <h2
                  ...
                  className="text-[#323232] font-semibold text-[20px] sm:text-[26px] lg:text-[30px] leading-[1.1] mb-4 sm:mb-6 lg:mb-[25px]"
                >
                ...
                <p
                  ...
                  className="max-w-[650px] text-left text-[#323232] text-[14px] font-normal leading-[1.715] mb-[40px] sm:mb-6 lg:mb-[40px] sm:text-[13px] lg:text-[14px] sm:max-w-[500px] lg:max-w-[650px]"
                >
                ...
                <button
                  ...
                  className="text-[#323232] sm:text-[14px] py-2 sm:py-[15px] px-4 sm:px-[40px] uppercase bg-transparent hover:bg-[#BC8246] cursor-pointer hover:border-[#BC8246] duration-300 hover:text-white border-[#323232] border-2 text-[14px] py-[15px] px-[40px] font-semibold"
                >
                  Discover Now
                </button>
              </div>
